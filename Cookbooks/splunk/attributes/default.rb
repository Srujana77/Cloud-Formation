...
#directories
default['splunk']['server_home']               = "/SEG3/splunk"
default['splunk']['db_directory']              = "/dbseg3/splunk"

#web config
default['splunk']['web_server_port']           = "87" # Change to 443/other if you're doing ssl
...
# limits.conf 
default['splunk']['max_searches_per_cpu']      = 8